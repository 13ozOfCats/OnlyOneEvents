<template>
	<div class="showreel desktop" :style="{display: display}">
		<video
			muted="muted"
			preload="auto"
			:src="videoLink"
		...
		<svg
			...
			viewBox="0 0 72 72"
			fill="none"
			class="showreel__sound"
			:class="muteClass"
			@click="muteVideo"
		>
			<rect class="showreel__svg" x="24" y="27" width="5" height="18" fill="white"></rect>
			<path
				class="showreel__svg"
		...
		<span class="showreel__btn btn" @click="hideVideo">
	...
	export default Vue.extend({
		...
		methods: {
			...
			playVideo: function () {
				...
				this.$refs.showreel.play();
			},
			hideVideo: function () {
				this.$refs.showreel.pause();
				this.display = 'none';
			...
			muteVideo: function () {
				...
				if (this.$refs.showreel.muted) {
					this.muteClass = 'showreel__sound-off';
				} else {
					this.muteClass ='showreel__sound-on';
				}
			},
		},
	});
