			...
			<div class="work__container" :style="{'background-image': 'url(' + background + ')'}">
				<div class="work__left">
					<div class="work__leftBox">
						<div class="work__logo" @click="goToTop">
					...
					<div class="work__leftBox">
						<div v-show="bema.show" class="work__prizeBox">
							<img src="./images/bema.png" alt="" />
							<span class="work__prize" v-html="bema.text"></span>
						</div>
					</div>
					<div class="work__leftBox">
						<div v-show="eoe.show" class="work__prizeBox">
							<img src="./images/oeo.png" alt="" />
							<span class="work__prize" v-html="eoe.text"></span>
						</div>
					</div>
					<div class="work__leftBox">
	...
	export default Vue.extend({
		...
		methods: {
			changeBg: function (id) {
				...
				if(this.posts[id - 1].prizes !== undefined) {
					if (this.posts[id - 1].prizes.bema !== undefined) {
						this.bema.show = true
						this.bema.text = this.posts[id - 1].prizes.bema
					} else {
						this.bema.show = false
					}
					if (this.posts[id - 1].prizes.eoe !== undefined) {
						this.eoe.show = true
						this.eoe.text = this.posts[id - 1].prizes.eoe
					} else {
						this.eoe.show = false
					}
				} else{
