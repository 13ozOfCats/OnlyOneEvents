...
export default new Vuex.Store({
	state: {
		shortcut: './video/shortcut.mp4',
		showreel: './video/showreel2.mp4',
		posts: [
			{
				id: 1,
				slug: 'rr-cullinan',
				...
				mainImg: './img/rr-cullinan_main.jpg',
				video: 'https://player.vimeo.com/video/420241411',
				gallery: [
					'./img/rr-cullinan_1.jpg',
					'./img/rr-cullinan_2.jpg',
					'./img/rr-cullinan_3.jpg',
					'./img/rr-cullinan_4.jpg',
					'./img/rr-cullinan_5.jpg',
					'./img/rr-cullinan_6.jpeg',
				],
				prizes: {
			...
			},
			{
				...
				mainImg: './img/marlboro-ppf_main.jpg',
				video: 'https://player.vimeo.com/video/234284565',
				gallery: [
					'./img/marlboro-ppf_1.jpg',
					'./img/marlboro-ppf_2.jpg',
					'./img/marlboro-ppf_3.jpg',
					'./img/marlboro-ppf_4.jpg',
					'./img/marlboro-ppf_5.jpg',
					'./img/marlboro-ppf_6.jpg',
					'./img/marlboro-ppf_7.jpg',
					'./img/marlboro-ppf_8.jpg',
					'./img/marlboro-ppf_9.jpg',
					'./img/marlboro-ppf_10.jpg',
					'./img/marlboro-ppf_11.jpg',
					'./img/marlboro-ppf_12.jpg',
					'./img/marlboro-ppf_13.jpg',
					'./img/marlboro-ppf_14.jpg',
					'./img/marlboro-ppf_15.jpg',
				],
			},
			{
				id: 7,
			...
			},
			{
				...
				mainImg: './img/marlboro-events_main.jpg',
				video: 'https://player.vimeo.com/video/234485953',
				gallery: [
					'./img/marlboro-events_1.jpg',
					'./img/marlboro-events_2.jpg',
					'./img/marlboro-events_3.jpg',
					'./img/marlboro-events_4.jpg',
					'./img/marlboro-events_5.jpg',
					'./img/marlboro-events_6.jpg',
					'./img/marlboro-events_7.jpg',
					'./img/marlboro-events_8.jpg',
					'./img/marlboro-events_9.jpg',
					'./img/marlboro-events_10.jpg',
					'./img/marlboro-pmef_1.jpg',
					'./img/marlboro-pmef_2.jpg',
					'./img/marlboro-pmef_3.jpg',
					'./img/marlboro-pmef_4.jpg',
					'./img/marlboro-pmef_5.jpg',
				],
			},
			{
				id: 11,
			...
			},
			{
				...
				mainImg: './img/legal_main.jpg',
				video: 'https://player.vimeo.com/video/344341071',
				gallery: [
					'./img/legal_2.jpg',
					'./img/legal_3.jpg',
					'./img/legal_4.jpg',
